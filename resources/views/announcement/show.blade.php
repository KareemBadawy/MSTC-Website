		...
		<div class="collapse navbar-collapse navbar-ex1-collapse" >
			...
			<ul class="nav navbar-nav navbar-right">
				<li style="padding-top: 3px;padding-right: 10px">
					...
					@else
						<ul class="nav">
							<li><a href="#subscribe" data-toggle="modal" style="background:none;" data-target="#myloginModal">Sign in</a></li>
						</ul>
					@endif
				</li>
			</ul>
...
<div class="container">
	<div class="row">
		@if(File::exists('image/announcements/'.$Announcement->title . '-announcement-' .$Announcement->id. '.jpg'))
			<div style=" width: 100%; height: 10em;overflow: hidden;">
				<img src="{{ asset('image/announcements/'.$Announcement->title . '-announcement-' .$Announcement->id. '.jpg' ) }}" width="400px" style=" min-width: 100%;
  min-height: 100%;" alt="...">
			</div>
		@else
  ...
  min-height: 100%;" alt="..."></div>
		...
		{{ $Announcement->ended_at }}
			@if(Auth::check())
				@if(Auth::user()->hasRole('Vice Head'))
                    <div class="row">
                        <a href="{{ url('/announcements', $Announcement->id.'/edit') }}" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-edit" ></span> Edit Event</a>
                       <a href="{{ url('/announcements', $Announcement->id.'/destroy') }}" class="btn btn-danger" role="button"><span class="glyphicon glyphicon-erase " ></span> Delete Event</a>
					</div>
                @endif
			@endif
	</div>
